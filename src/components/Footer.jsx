...
import { 
  Mail, Instagram, Youtube, MapPin, Clock, Shield, Globe, 
  Phone, ArrowRight, ChevronRight, Zap, MessageCircle // ✅ WhatsApp icon import
} from 'lucide-react';
...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#050505] border-t border-white/5 pt-16 pb-6 w-full z-10">
          ...
          <div className="grid md:grid-cols-12 gap-10 mb-10 border-b border-white/5 pb-12">
             <div className="md:col-span-5">
                ...
                <div className="flex gap-3">
                   ...
                   {/* YouTube Link - FIXED */}
                   <a 
                     href="https://www.youtube.com/@9T9Esports"
                     target="_blank" 
                     rel="noopener noreferrer"
                     className="w-10 h-10 flex items-center justify-center bg-[#151515] rounded-full hover:bg-[#FF0000] hover:text-white transition-all duration-300 border border-white/5"
             ...
             <div className="col-span-2">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                    <div className="bg-[#0a0a0a] p-4 rounded-xl border border-white/5 hover:border-brand-green/30 transition group">
                        ...
                        <a href="mailto:9t9tournaments@gmail.com" className="text-white text-sm hover:text-brand-green">9t9tournaments@gmail.com</a>
                    </div>
                    <div className="bg-[#0a0a0a] p-4 rounded-xl border border-white/5 hover:border-brand-green/30 transition group">
                        ...
                        <p className="text-white text-sm">8:00 AM - 11:00 PM</p>
                    </div>
                </div>
             </div>
          </div>
